...
BEGIN TRY
    ...
    -- Cấu hình hiển thị đầy đủ tất cả cột của Sản phẩm (Bao gồm Form dáng, Hiện Web, Ngưng hoạt động)
    ('frmProduct',      'LISTEDIT', N'Danh mục sản phẩm', 'Product List', 'dbo.CF_TenHang2Tbl', 'ItemName2', 'TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'ItemName2;TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'UserAutoID;GiaMua;UnitCost;BarCode'),
    ('WEB_ProductFrm',  'LISTEDIT', N'Danh mục sản phẩm', 'Product List', 'dbo.CF_TenHang2Tbl', 'ItemName2', 'TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'ItemName2;TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'UserAutoID;GiaMua;UnitCost;BarCode'),
    ('ProductListFrm',  'LISTEDIT', N'Danh mục sản phẩm', 'Product List', 'dbo.CF_TenHang2Tbl', 'ItemName2', 'TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'ItemName2;TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'UserAutoID;GiaMua;UnitCost;BarCode'),
    ('ItemListFrm',     'LISTEDIT', N'Danh mục sản phẩm', 'Product List', 'dbo.CF_TenHang2Tbl', 'ItemName2', 'TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'ItemName2;TenHangHoa;CategoryID;Unit;UnitPrice;Size;MauSac;Form;isWeb;isDisable', 'UserAutoID;GiaMua;UnitCost;BarCode'),
